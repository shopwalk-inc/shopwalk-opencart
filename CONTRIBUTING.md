# Contributing to shopwalk-opencart
...
- **Vendor-neutral at Tier 1.** Code under `upload/catalog/controller/extension/shopwalk_ucp/` and `upload/system/library/shopwalk_opencart/` must work for any UCP agent, not just Shopwalk. Shopwalk-specific behavior lives under admin dashboard CTAs (Tier 2, optional).
...
4. In OpenCart admin: **Extensions → Extensions → Modules → Shopwalk → Install**.
